<script>
	...
	mensagens['txt_col_cgi'] = "${msgs.txt_col_cgi}";
	mensagens['txt_col_bilhetador'] = "${msgs.txt_col_bilhetador}";
    ...
    mensagens['txt_ufs'] = "${msgs.txt_ufs}";
	mensagens['txt_col_setor_nao_identificado'] = "${msgs.txt_col_setor_nao_identificado}";
	mensagens['txt_col_central'] = "${msgs.txt_col_central}";
