...
<script type="text/javascript" src='${pageContext.request.contextPath}/dwr/interface/AlterarDadosAjax.js'></script>
...
<div class="estiloForm" id="dlgAlterarDados" style="display: none">
	<form id="formAlterarDados">
		...
		<div class="inlinebox formAlterarDados">
			<label> ${msgs.txt_login}<span class="campoObrigatorio">*</span> </label> <input id="loginDados" type="text" readonly="readonly" class="obrigatorio" maxlength="25" tipo="semespecial"/>
			<label> ${msgs.txt_nome}<span class="campoObrigatorio">*</span> </label> <input id="nomeDados" type="text" class="obrigatorio" maxlength="50" tipo="semespecial"/>
			<label> ${msgs.txt_email}<span class="campoObrigatorio">*</span> </label> <input id="emailDados" type="text" class="obrigatorio" tipo="email" maxlength="60" tipo="semespecial"/>
		...
		<div class="inlinebox formAlterarDados" style="margin-right: 0px;">
			...
			<label> ${msgs.txt_regional} </label> <select id="regionalDados"></select> 
			<label> ${msgs.txt_responsavel}: </label> <input id="responsavelDados" type="text" maxlength="50" tipo="semespecial"/> 
		</div>
		<hr style="clear: both">
		<p style="text-align: center; color: red;" id="textoPrimeiroAcesso">${msgs.txt_primeiro_acesso_sistema}</p>
