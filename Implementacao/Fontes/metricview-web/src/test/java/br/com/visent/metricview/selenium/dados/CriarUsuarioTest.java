...
public class CriarUsuarioTest {
	...
	public void cadastrarUsuario() throws InterruptedException{
		...
		for (int i = 0; i < sheet.getLastRowNum(); i++) {
			row = sheet.getRow(i);						
			Thread.sleep(500);
			driver.findElement(By.id("loginUsuario")).sendKeys(row.getCell(0).getStringCellValue());
			Thread.sleep(500);
			driver.findElement(By.id("nomeUsuario")).sendKeys(row.getCell(1).getStringCellValue());
			Thread.sleep(500);
			driver.findElement(By.id("emailUsuario")).sendKeys(row.getCell(2).getStringCellValue());
			Thread.sleep(500);
