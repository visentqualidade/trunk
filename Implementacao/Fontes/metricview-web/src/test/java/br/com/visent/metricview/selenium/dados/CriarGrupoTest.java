...
public class CriarGrupoTest {
	...
	@Test
	public void criarGrupos() throws InterruptedException{
	...
	public void cadastrarGrupos() throws InterruptedException{
		try {
		...
		for (int i = 0; i < sheet.getLastRowNum(); i++) {
			row = sheet.getRow(i);	
			Thread.sleep(500);	
			driver.findElement(By.id("nomeGrupo")).sendKeys(row.getCell(0).getStringCellValue());
			Thread.sleep(500);
			driver.findElement(By.id("descricaoGrupo")).sendKeys(row.getCell(1).getStringCellValue());
			Thread.sleep(500);
			driver.findElement(By.xpath("//span[contains(text(),'Salvar')]")).click();
			Thread.sleep(500);	
		}
	}
