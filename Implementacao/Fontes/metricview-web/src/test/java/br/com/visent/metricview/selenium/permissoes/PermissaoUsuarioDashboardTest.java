...
public class PermissaoUsuarioDashboardTest extends BaseTestCase{
	...
	public PermissaoUsuarioDashboardTest(String _login, String _nome, String _email, 
	...
	public void permisaoUsuario(){
		...
		permissaoUsuarioPage.selecionaPermissaoUsuario("Usuários", "Usuário", nome + " " + "(" + login + ")", "Dashboard");
		...
		permissaoUsuarioPage.validaIndividual(login, "Usuário", "0");

		driver.findElements(By.id("Fechar")).get(1).click();  // Fecha a modal de Visualizar Usuarios
		driver.findElements(By.id("Fechar")).get(0).click();  //Fecha a modal de permissoes
	...
	public void permissaoAdministrador(){
		...
		permissaoUsuarioPage.selecionaPermissaoUsuario("Usuários", "Administrador", nomeAdm + " " + "(" + loginAdm + ")", "Dashboard");
		...
		permissaoUsuarioPage.validaIndividual(loginAdm, "Administrador", "Visões Gerenciais.");
	...
	public static List<Object[]>datadriven(){
		return Arrays.asList(new Object[][]{
			{"mariana", "Mariana", "mariana@visent.com.br2", "TESTE AREA", "879285539", "Claro DF", "TESTE RESPONSAVEL", "Dashboard", "janaina", "Janaina", "janaina@visent.com.br", "GRUPO DASHBOARD", "Grupo equipe claro"},
		});
	}
